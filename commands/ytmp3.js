...
module.exports = {
    pattern: "play",
    desc: "Secha nekutsvaga kubva kuSpotify/YouTube tracks as playable audio",
    react: "🎧",
    category: "music",
    filename: __filename,
...
.play https://open.spotify.com/track/2ksyzVfU0WJoBpu8otr4pz`);
            ...
            if (query.includes("youtube.com/track/")) {
                await sendMessageWithContext("🎶 Downloading track from youtube... Please wait.");
                ...
                if (!audioData) {
                    try {
                        const api = `https://api.botcahx.eu.org/api/dowloader/yt?url=${convert.url}&apikey=${btc}`;
                        const { data } = await axios.get(api, { timeout: 20000 });
