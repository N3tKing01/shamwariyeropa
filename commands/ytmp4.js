...
module.exports = {
  pattern: "ytmp4",
  desc: "Download YouTube video in MP4 format using Iconic-Tech | Cyril API",
  react: "🎬",
  category: "downloader",
  filename: __filename,
  ...
  execute: async (conn, mek, m, { from, q, reply }) => {
      ...
      return await conn.sendMessage(from, {
        ...
        contextInfo: {
          ...
          forwardedNewsletterMessageInfo: {
            ...
            newsletterName: "MIDKING-TECH - LDT",
            serverMessageId: 200
          }
        }
      }, { quoted: quoted });
    ...
    try {
      ...
      // API call
      const apiUrl = `https://api-rin-tohsaka.vercel.app/download/ytmp4?url=`;
