...
module.exports = {
  ...
  execute: async (conn, mek, m, { from, reply, q }) => {
    ...
    try {
      ...
      const apiUrl = `https://api.betabotz.eu.org/api/download/tiktok?url=${encodeURIComponent(q)}`;
      ...
      if (!videoUrl) return await sendMessageWithContext("❌ Ndashaiwa vid repaTikTok.");
